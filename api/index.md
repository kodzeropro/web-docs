...
::: info Server-to-server сценарии
Если запросы выполняются с вашего backend-сервера (а не из браузера), и вам нужен административный профиль, см. раздел [Серверная интеграция](/server-integration/).
:::
