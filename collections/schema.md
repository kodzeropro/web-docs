...
Визуальный редактор контента. Значение хранится в формате markdown-разметки.
...
> Индексация и уникальность **недоступны** для типов: Дата и время, Да/Нет, JSON, Список, Контент.